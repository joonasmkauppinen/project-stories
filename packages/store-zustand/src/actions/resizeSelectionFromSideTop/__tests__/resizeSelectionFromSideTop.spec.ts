...
import { resizeSelectionFromSideTop } from '../resizeSelectionFromSideTop';

describe('Action - resizeSelectionFromSideTop()', () => {
  test('Updates layer size and position correctly', () => {
    ...
    // Move top side down ⬇️
    resizeSelectionFromSideTop({ movementY: 10 });
